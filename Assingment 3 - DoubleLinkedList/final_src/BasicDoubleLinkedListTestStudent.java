...
public class BasicDoubleLinkedListTestStudent {
	...
	public Car a=new Car("Jeep", "Renegade", 2005);
	public Car b=new Car("Honda", "Civic", 2005);
	public Car c=new Car("Subaru", "Outback", 2005);
	public Car d=new Car("Chevrolet", "Silverado", 2005);
	public Car e=new Car("Chrysler", "PTCruiser", 2005);
	public Car f=new Car("Ford", "F150", 2005);
	...
	public void setUp() throws Exception {
		...
		linkedString.addToEnd("Open");
		linkedString.addToEnd("Sesame");
	...
	public void testAddToEnd() {
		assertEquals("Sesame", linkedString.getLast());
	...
	public void testAddToFront() {
		assertEquals("Open", linkedString.getFirst());
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals("Open", iterator.next());
		assertEquals("Sesame", iterator.next());
		assertEquals(true, iterator.hasNext());
	...
	public void testRetrieveFirstElement() {
		...
		assertEquals("Open",linkedString.getFirst());
		assertEquals("Open", linkedString.retrieveFirstElement());
		assertEquals("Sesame",linkedString.getFirst());
